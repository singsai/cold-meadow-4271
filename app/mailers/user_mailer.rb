class UserMailer < ActionMailer::Base
  ...
  def welcome_email(user, version)
    ...
    if version == "free"
      ...
      :content_type => "text/html", :body => "Thank you for signing up for a trial version of <a href='http://skype.verbalizeit.com'>VerbalizeIt for Skype</a> (#{user.expected_usage}). Your Skype name is: #{user.skype} 
      <br/>
<ul>
    <li>
    ...
    <li>
      To view a brief explanatory video on how to use VerbalizeIt for Skype, please visit <a href='http://youtu.be/Pm-HCm0_SUc'>http://youtu.be/Pm-HCm0_SUc</a> 
    </li
</ul>      
You can make additional calls by signing up for the <a href='http://skype.verbalizeit.com'>premium version</a> by visiting <a href='http://skype.verbalizeit.com'>skype.verbalizeit.com</a>.
      ...
      mail(:to => user.email, :bcc => "info@verbalizeit.com", :subject => "Thank you for Signing up with VerbalizeIt for Skype!", 
      :content_type => "text/html", :body => "Thank you for signing up with <a href='http://skype.verbalizeit.com'>VerbalizeIt for Skype</a> #{user.expected_usage}. Your Skype name is: #{user.skype} <br/>
...
<ul>
    ...
    <li>
      To view a brief explanatory video on how to use VerbalizeIt for Skype, please visit <a href='http://youtu.be/Pm-HCm0_SUc'</a>http://youtu.be/Pm-HCm0_SUc</a> 
    </li    
</ul>
